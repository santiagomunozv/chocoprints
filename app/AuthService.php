...
class AuthService
{
    ...
    private static function setMenuModels($data)
    {
        ...
        Session::put('packageDinamicMenuChocoprintsPaquetes', LoginFactory::buildPaquetes($menuGeneral));
        Session::put('packageDinamicMenuChocoprintsModulos', LoginFactory::buildModulos($menuGeneral));
        Session::put('packageDinamicMenuChocoprintsOpciones', LoginFactory::buildOpcion($menuGeneral));
    }
