...
class ChocoprintsModal {
     ...
     *
     * @returns {ChocoprintsModal} este mismo objeto
     * @author Santiago Muñoz
     * @since v 1.0
     */
    sinPie() {
     ...
     * es el metodo empleado por defecto por esta clase en el metodo @see {ChocoprintsModal#mostrarModal}.
     *
     * @returns {ChocoprintsModal} este mismo objeto
     * @author Santiago Muñoz
     * @since v 1.0
     ...
     *
     * @see {ChocoprintsModal#mediano}
     * @see {ChocoprintsModal#grande}
     * @see {ChocoprintsModal#extraGrande}
     *
     * @returns {ChocoprintsModal} este mismo objeto
     * @author Santiago Muñoz
     * @since v 1.0
     ...
     *
     * @see {ChocoprintsModal#construirTitulo}
     * @see {ChocoprintsModal#construirCuerpo}
     * @see {ChocoprintsModal#construirPie}
     * @see {ChocoprintsModal#construirContenedorPrincipal}
     *
     ...
     * metodo @see {ChocoprintsModal#cargando}
     *
     * @param {Object:requerido} contenedor
     * @author Santiago Muñoz
     * @since v 1.0
